...
public class VolleyNetUtils {
    ...
    private static volatile VolleyNetUtils mInstance = null;
    private static final Object InstanceLock = new Object();
    private Context context;

    public static VolleyNetUtils getInstance(Context appContext) {
        if (appContext != null) {
            ...
            if (mInstance == null) {
                synchronized (InstanceLock) {
                    if (mInstance == null) {
                        mInstance = new VolleyNetUtils(appContext);
                    }
                }
            }
            return mInstance;
    ...
    private VolleyNetUtils(Context context) {
...
//                        ActiveAndroid.beginTransaction();
                        ...
                        try {
                            ...
                            MainActivity.notifyVolleyImageListAdaptor();
                        }
